/**
 * AdminLoginPage - Admin Sign-in (Google or Email/Password)
 */
...
const AdminLoginPage = () => {
  ...
  const { admin, isAdmin, loading, error, signIn, signInWithEmail, clearError } = useAdmin();
          ...
          <div className="bg-[#0D2821] text-white px-6 py-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm opacity-70">Sign in to access admin dashboard</p>
              </div>
            </div>
          </div>

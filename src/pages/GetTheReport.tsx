...
const GetTheReport = () => {
  ...
  const downloadPDF = async () => {
    ...
    try {
      ...
      pdf.text('Planetary Performance Score', pageWidth / 2, yPosition, { align: 'center' });
      yPosition += 10;
      ...
      for (let i = 1; i <= totalPages; i++) {
        ...
        pdf.text(
          'Generated by Erthaloka Planetary Performance Score System',
          pageWidth / 2,
          pageHeight - 10,
          { align: 'center' }
        );
      ...
      // Save the PDF
      pdf.save(`PPS_Report_${latitude?.toFixed(2)}_${longitude?.toFixed(2)}_${new Date().toISOString().split('T')[0]}.pdf`);
        ...
        <div className="container px-4 mx-auto">
          ...
          >
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4">
              {isPolygon ? 'Land Parcel Analysis' : 'Planetary Performance Score'}
            </h1>
                ...
                {polygonData.ecosystem_service_value?.available && (
                  <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between items-center py-2 border-b border-white/10">
                        <span className="text-green-100">Baseline Natural Capital Value</span>
                        <span className="text-white font-semibold">
        ...
        <div className="container px-4 mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 mb-8">
              Get a complete PDF copy of this Planetary Performance Score report with all remote sensing data,
